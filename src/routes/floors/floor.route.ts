...
import { handleDeleteFloorReq, handleGetFloorDetailsReq, handleGetFloorListReq, handleUpdateFloorReq } from "../../controllers/floors/floor.controller";
import { validateCreateFloorInReq, validateFloorIdInReq, validateUpdateFloorInReq } from "../../validations/index";
